package com.example.fourtofourfinal.Presentation.Tasks.WordTask;
...
import com.example.fourtofourfinal.Presentation.Tasks.CustomWord;
import com.example.fourtofourfinal.R;
import com.example.fourtofourfinal.Utils.ActivityNavigation;
import com.example.fourtofourfinal.Utils.Injection;
    ...
    private class TouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == MotionEvent.ACTION_DOWN && !customLayout.empty()) {
                ...
                mtts.speak(customWord.getText().toString(),TextToSpeech.QUEUE_FLUSH,null);
