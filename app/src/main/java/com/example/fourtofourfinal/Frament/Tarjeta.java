 ...
 * {@link //Tarjeta.OnFragmentInteractionListener} interface
...
public class Tarjeta extends Fragment {
   ...
   /* public static Tarjeta newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frament_tarjeta, container, false);
        ImageView mImageView = (ImageView) view.findViewById(R.id.imageView14);
        mImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(),DatosTarjetas.class);
